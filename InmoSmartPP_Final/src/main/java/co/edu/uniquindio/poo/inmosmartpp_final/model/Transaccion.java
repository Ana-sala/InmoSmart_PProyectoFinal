...
public class Transaccion {
    ...
    public Transaccion(String codigoTransaccion, Comprador comprador, Vendedor vendedor,
        ...
        if (tipoOperacion == TipoOperacion.VENTA) inmueble.setEstado(EstadoInmueble.VENDIDO);
        else inmueble.setEstado(EstadoInmueble.ARRENDADO);
    }

    public String getCodigoTransaccion() { return codigoTransaccion; }
    public void setCodigoTransaccion(String c) { this.codigoTransaccion = c; }
    ...
    public void setTipoOperacion(TipoOperacion t) { this.tipoOperacion = t; }
    public LocalDate getFecha() { return fecha; }
    public void setFecha(LocalDate fecha) { this.fecha = fecha; }

    @Override
    public String toString() {
        return codigoTransaccion + " | " + tipoOperacion + " | " + inmueble.getCodigo() + " - $" + valorFinal;
    }
}
